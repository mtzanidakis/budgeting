...
const translations = {
    en: {
        ...
        'categories.category_required': 'Category is required',
        ...
        'tokens.description': 'Use API tokens to access the budgeting API from scripts or AI agents. Treat them like passwords.',
        'tokens.generate': 'Generate new token',
        'tokens.name': 'Name',
        'tokens.name_placeholder': 'e.g. laptop-cli',
        'tokens.expires': 'Expires',
        'tokens.expires_note': 'Optional. Leave blank for a token that never expires.',
        'tokens.created': 'Created',
        'tokens.last_used': 'Last used',
        'tokens.never': 'Never',
        'tokens.delete': 'Revoke',
        'tokens.confirm_delete': 'Revoke this token? Any client using it will lose access.',
        'tokens.empty_title': 'No API tokens',
        'tokens.empty_text': 'Click "Generate new token" to create your first API token.',
        'tokens.created_success': 'Token created. Copy it now — it will not be shown again.',
        'tokens.copy': 'Copy',
        'tokens.copied': 'Copied!',
        'tokens.copy_warning': 'This token is shown only once. Store it securely.',
        'tokens.done': 'Done',
        'tokens.failed_list': 'Failed to load tokens',
        'tokens.failed_create': 'Failed to create token',
        'tokens.failed_delete': 'Failed to revoke token',
        'tokens.name_required': 'Name is required',
    ...
    el: {
        ...
        'categories.category': 'Κατηγορία',
        'categories.category_required': 'Η κατηγορία είναι υποχρεωτική',
        ...
        'nav.api_tokens': 'API Tokens',
        'tokens.title': 'API Tokens',
        'tokens.description': 'Χρησιμοποιήστε API tokens για πρόσβαση στο API από scripts ή AI agents. Φυλάξτε τα όπως τους κωδικούς σας.',
        'tokens.generate': 'Δημιουργία νέου token',
        'tokens.name': 'Όνομα',
        'tokens.name_placeholder': 'π.χ. laptop-cli',
        'tokens.expires': 'Λήξη',
        'tokens.expires_note': 'Προαιρετικό. Αφήστε κενό για token χωρίς λήξη.',
        'tokens.created': 'Δημιουργήθηκε',
        'tokens.last_used': 'Τελευταία χρήση',
        'tokens.never': 'Ποτέ',
        'tokens.delete': 'Ανάκληση',
        'tokens.confirm_delete': 'Ανάκληση αυτού του token; Όποιος το χρησιμοποιεί θα χάσει την πρόσβαση.',
        'tokens.empty_title': 'Κανένα API token',
        'tokens.empty_text': 'Πατήστε "Δημιουργία νέου token" για να φτιάξετε το πρώτο σας token.',
        'tokens.created_success': 'Το token δημιουργήθηκε. Αντιγράψτε το τώρα — δεν θα εμφανιστεί ξανά.',
        'tokens.copy': 'Αντιγραφή',
        'tokens.copied': 'Αντιγράφηκε!',
        'tokens.copy_warning': 'Αυτό το token εμφανίζεται μία μόνο φορά. Αποθηκεύστε το με ασφάλεια.',
        'tokens.done': 'Τέλος',
        'tokens.failed_list': 'Αποτυχία φόρτωσης tokens',
        'tokens.failed_create': 'Αποτυχία δημιουργίας token',
        'tokens.failed_delete': 'Αποτυχία ανάκλησης token',
        'tokens.name_required': 'Το όνομα είναι υποχρεωτικό',
